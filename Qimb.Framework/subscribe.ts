...
class SubscribeRequest {
    ...
    public async execute() {
        ...
        var subscribeMessageTypeQueuePromise = this.subscribe(topicArn, messageTypeQueueDetails.queueArn);
        var subscribeSubscriberQueuePromise = this.subscribe(topicArn, subscriberQueueDetails.queueArn);
