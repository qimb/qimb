...
declare module "aws-sdk" {
    ...
    export class SNS {
        constructor(options?: any);
        publish(params: SNS.PublishParams, callback: (err: any, data: SNS.PublishResult) => void): void;
        createTopic(params: SNS.CreateTopicParams, callback: (err: any, data: SNS.CreateTopicResult) => void): void;
        deleteTopic(params: SNS.DeleteTopicParams, callback: (err: any, data: SNS.DeleteTopicResult) => void): void;
        subscribe(params: SNS.SubscribeParams, callback: (err: any, data: SNS.SubscribeParams) => void): void;
        unsubscribe(params: SNS.UnsubscribeParams, callback: (err: any, data: SNS.UnsubscribeParams) => void): void;
    }
